                    ...
                    <div className="grid grid-cols-12 gap-6 ">
                                        ...
                                        <div key={index}>
                                            ...
                                            <div className="flex items-center justify-between py-2">
                                                ...
                                                <div className={`flex items-center gap-2 ${item.color}`}>
                                                    ...
                                                    <span className={`text-2xl leading-none ${item.arrow == "↑" ? "text-[#6BAF41]" : "text-red-600"}`}>
                                                        {item.arrow}
                                                    </span>
                                                    <span className={`text-sm ${item.arrow == "↑" ? "text-[#6BAF41]" : "text-red-600"}`}>
                                                        {item.value}
                                                    </span>
                        ...
                        <div className="col-span-3 bg-white rounded-3xl p-5">
                            <div className="flex justify-between items-center mb-12">
                                <h3 className='text-2xl  text-[#6B6F77] text-start'>نمره کلی بدن</h3>
                                <p className='text-[#969696] font-primary-light'>وضعیت : <span className='text-[#6BAF41]'>عالی</span></p>
                            </div>
                            <div className="flex justify-center items-center">
                                <div className="w-52 flex justify-center items-center relative">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-[#6B6F77] text-5xl">
                                        50 <span className='text-sm font-primary-light '>از 100</span>
                                    </div>
                                </div>
                            </div>
                        </div>
